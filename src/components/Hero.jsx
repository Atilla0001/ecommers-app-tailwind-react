        ...
        <div className='text-white'>
            <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
                ...
                <div className='flex justify-center'>
                    ...
                    <ReactTyped
                        className='md:text-5xl sm:text-4xl text-xl text-gray-500 font-bold pl-1'
                        strings={["Saas","BTC","FOREX"]}
                        typeSpeed={250}
                        loop
                    />
                </div>
                <ReactTyped
                        ...
                        loop
                    />
                    <button className='flex justify-center text-white font-bold bg-[#00df9a] max-w-[150px] rounded mx-auto px-8 py-1 mt-1'>Get Started</button>
            </div>
        </div>
    )
}
